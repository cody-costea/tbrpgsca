...
class DemoAct : AppCompatActivity(), ArenaStager {
    ...
    private fun getSkills(state: Array<State>): Array<Ability> {
        ...
        return arrayOf(
                ...
                AdAbility(7, this.getString(R.string.skill_regen), 0, 0, false, true, 4, 0, 10, 0, 3, 1, -37, 0, 0, 0, 6, -1, -1, false, true, regen, poison),
                AdAbility(8, this.getString(R.string.skill_prayer), 0, 0, false, true, 5, 0, 7, 0, 3, 1, -23, 0, 0, 1, 0, -1, -1, false, true, null, null),
                AdAbility(9, this.getString(R.string.skill_smite), 0, 0, false, false, 1, 1, 0, 2, 1, 1, 4, 3, -4, 0, 1, -1, -1, false, false, null, confclarity),
                AdAbility(10, this.getString(R.string.skill_hit), 0, 0, false, false, 1, 3, 0, 1, 0, 1, 12, 0, -4, 0, 1, -1, -1, false, false, null, confsleep),
                AdAbility(11, this.getString(R.string.skill_bash), 0, 0, false, false, 3, 3, 0, 5, 1, 1, 7, 5, -5, 0, 1, -1, -1, false, false, dizziness, confclarity),
                AdAbility(12, this.getString(R.string.skill_smash), 0, 0, false, false, 3, 5, 0, 3, 0, 1, 18, 0, -7, 0, 1, -1, -1, false, false, null, confsleep),
                AdAbility(13, this.getString(R.string.skill_berserk), 0, 0, false, false, 4, 7, 0, 4, 3, 1, 0, 0, 0, -1, 0, -1, -1, false, false, berserk, weakness),
                AdAbility(14, this.getString(R.string.skill_shock), 0, 0, false, false, 4, 4, 0, 7, 1, 1, 10, 5, -9, 0, 7, -1, -1, false, false, dizzystun, confclarity),
                AdAbility(15, this.getString(R.string.skill_crush), 0, 0, false, false, 5, 7, 4, 0, 0, 1, 25, 0, -11, 0, 1, -1, -1, false, false, stun, confsleep),
                AdAbility(16, this.getString(R.string.skill_strike), 0, 0, false, true, 1, 0, 0, 0, 4, 1, 13, 0, -3, 0, 1, 5, 3, false, false, null, confsleep),
                AdAbility(17, this.getString(R.string.skill_steal), 0, 0, true, true, 1, 0, 0, 0, 3, 1, 0, 0, 0, 0, 1, 5, 3, false, false, null, null),
                AdAbility(18, this.getString(R.string.skill_dash), 0, 0, false, true, 3, 0, 0, 0, 4, 1, 15, 0, -5, 0, 1, 3, 7, false, false, null, confsleep),
                AdAbility(19, this.getString(R.string.skill_poison), 0, 0, false, true, 3, 0, 0, 0, 4, 2, 5, 0, 2, 0, 1, 3, 7, false, false, poison, regen),
                AdAbility(20, this.getString(R.string.skill_mug), 0, 0, true, true, 4, 0, 0, 0, 4, 2, 15, 0, -7, 0, 1, 1, 5, false, false, null, confsleep),
                AdAbility(21, this.getString(R.string.skill_toxic_gas), 0, 0, false, true, 4, 0, 10, 0, 6, 3, 1, 1, 1, 1, 1, 3, 7, false, false, tpoison, tregen),
                AdAbility(22, this.getString(R.string.skill_cheer), 0, 0, false, true, 4, 0, 10, 0, 3, -1, 0, 0, -5, -2, 0, 3, 7, false, false, vigour, cure),
                AdAbility(23, this.getString(R.string.skill_venom_blade), 0, 0, false, false, 5, 0, 0, 10, 4, 1, 17, 0, -9, 0, 1, 3, 7, false, false, poison, conftregen),
                AdAbility(24, this.getString(R.string.skill_absorb), 0, 0, false, true, 1, 0, 0, 3, 2, 1, 0, 7, -3, 0, 6, -1, -1, true, false, null, null),
                AdAbility(25, this.getString(R.string.skill_drain), 0, 0, false, true, 3, 0, 10, 0, 2, 1, 15, 0, -3, 0, 6, -1, -1, true, false, null, null),
                AdAbility(26, this.getString(R.string.skill_fireball), 0, 0, false, true, 1, 0, 3, 0, 2, 1, 11, 0, -5, 0, 2, -1, -1, false, false, null, sleep),
                AdAbility(27, this.getString(R.string.skill_iceshard), 0, 0, false, true, 1, 0, 3, 0, 2, 1, 11, 0, -5, 0, 3, -1, -1, false, false, null, sleep),
                AdAbility(28, this.getString(R.string.skill_lighting), 0, 0, false, true, 1, 0, 3, 0, 2, 1, 11, 0, -5, 0, 4, -1, -1, false, false, null, sleep),
                AdAbility(29, this.getString(R.string.skill_rock), 0, 0, false, true, 1, 0, 3, 0, 2, 1, 11, 0, -5, 0, 5, -1, -1, false, false, null, sleep),
                AdAbility(30, this.getString(R.string.skill_darkness), 0, 0, false, true, 1, 0, 3, 0, 2, 1, 11, 0, -5, 0, 6, -1, -1, false, false, null, sleep),
                AdAbility(31, this.getString(R.string.skill_flame), 0, 0, false, true, 3, 0, 5, 0, 2, 1, 15, 0, -7, 1, 2, -1, -1, false, false, null, sleep),
                AdAbility(32, this.getString(R.string.skill_blizzard), 0, 0, false, true, 3, 0, 5, 0, 2, 1, 15, 0, -7, 1, 3, -1, -1, false, false, null, sleep),
                AdAbility(33, this.getString(R.string.skill_storm), 0, 0, false, true, 3, 0, 5, 0, 2, 1, 15, 0, -7, 1, 4, -1, -1, false, false, null, sleep),
                AdAbility(34, this.getString(R.string.skill_earthquake), 0, 0, false, true, 3, 0, 5, 0, 2, 1, 15, 0, -7, 1, 5, -1, -1, false, false, null, sleep),
                AdAbility(35, this.getString(R.string.skill_eclipse), 0, 0, false, true, 3, 0, 5, 0, 2, 1, 13, 0, -7, 1, 6, -1, -1, false, false, null, sleep),
                AdAbility(36, this.getString(R.string.skill_flare), 0, 0, false, true, 5, 0, 12, 0, 2, 2, 25, 0, -9, 0, 1, -1, -1, false, false, null, sleep),
                AdAbility(37, this.getString(R.string.skill_light_ray), 0, 0, false, true, 1, 0, 3, 0, 3, 1, 11, 0, -5, 0, 7, -1, -1, false, false, null, sleep),
                AdAbility(38, this.getString(R.string.skill_light_burst), 0, 0, false, true, 3, 0, 5, 0, 3, 1, 15, 0, -7, 1, 7, -1, -1, false, false, null, sleep),
                AdAbility(39, this.getString(R.string.skill_confusion), 0, 0, false, true, 5, 0, 15, 0, 2, 1, 0, 0, 0, 0, 6, -1, -1, false, false, confusion, clarity),
                AdAbility(40, this.getString(R.string.skill_sleep), 0, 0, false, true, 4, 0, 0, 17, 4, 1, 3, 0, 17, 0, 1, -1, -1, false, false, sleep, clarity),
                AdAbility(41, this.getString(R.string.skill_slash), 0, 0, false, true, 5, 0, 10, 0, 4, 1, 15, 0, 0, 1, 1, 3, 7, false, false, null, confsleep),
                AdAbility(42, this.getString(R.string.skill_fire_wpn), 0, 0, false, false, 2, 0, 3, 2, 5, 1, 17, 0, -7, 0, 2, -1, -1, false, false, null, confsleep),
                AdAbility(43, this.getString(R.string.skill_ice_wpn), 0, 0, false, false, 2, 0, 3, 2, 5, 1, 17, 0, -7, 0, 3, -1, -1, false, false, null, confsleep),
                AdAbility(44, this.getString(R.string.skill_electric_wpn), 0, 0, false, false, 2, 0, 3, 2, 5, 1, 17, 0, -7, 0, 4, -1, -1, false, false, null, confsleep),
                AdAbility(45, this.getString(R.string.skill_stone_wpn), 0, 0, false, false, 2, 0, 3, 2, 5, 1, 17, 0, -7, 0, 5, -1, -1, false, false, null, confsleep),
                AdAbility(46, this.getString(R.string.skill_dark_wpn), 0, 0, false, false, 2, 0, 3, 2, 5, 1, 17, 0, -7, 0, 6, -1, -1, false, false, null, confsleep),
                AdAbility(47, this.getString(R.string.skill_vampiric_wpn), 0, 0, false, false, 5, 0, 10, 0, 5, 1, 21, 0, -9, 0, 6, 3, 7, true, false, null, confsleep),
                AdAbility(48, this.getString(R.string.skill_reflect), 0, 0, false, true, 5, 0, 10, 0, 3, 1, 0, 0, 0, 0, 0, -1, -1, false, false, reflect, null),
                AdAbility(49, this.getString(R.string.skill_meteor), 0, 0, false, true, 5, 0, 17, 0, 2, 1, 19, 0, -11, 1, 1, -1, -1, false, false, null, sleep),
                ...
                AdAbility(57, this.getString(R.string.skill_absorb), 0, 0, false, true, 1, 0, 0, 3, 3, 1, 0, 7, -3, 0, 7, -1, -1, true, false, null, null)
        )
    }
