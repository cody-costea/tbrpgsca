...
public class DemoAct extends Activity {
	...
	private Job[] AddJobs()
	{
        ...
        pcJob[4]=new Job(4, "Rogue",0,0,1, 1,0,0,0,1, new int[]{}, new Ability[]{this.Skill[15],this.Skill[16],this.Skill[17],this.Skill[18],this.Skill[22],this.Skill[38]});
        ...
        pcJob[10]=new Job(10, "Swashbuckler",0,0,1, 1,0,0,0,1, new int[]{}, this.Skill, new int[]{8,9,10,11,15,16,17,18,19});
    ...
    private Ability[] AddSkills()
    {
    	...
    	ability[0]=new Ability(1, "Attack", true,false, 0, 0,0,0, 0,1, 10,0,-3, 0,1, false, nostate, confsleep);
        ability[1]=new Ability(2, "Defend", true,true, 0, 0,0,0, 3,1, 0,-1,-2, -1,0, false, nostate, nostate);
        ability[2]=new Ability(3, "Heal", false,true, 1, 0,3,0, 3,1, -25,0,0, 0,6, false, revive, nostate);
        ability[3]=new Ability(4, "Meditate", true,true, 1, 0,0,0, 3,-1, -1,-7,10, -1,6, false, nostate, dizziness);
        ability[4]=new Ability(5, "Cure", false,true, 3, 0,7,0, 3,1, -17,0,0, 0,7, false, revive, cure);
        ability[5]=new Ability(6, "Clarity", true,true, 3, 0,0,7, 3,1, 0,-3,0, 0,6, false, clarity, madness);
        ...
        ability[8]=new Ability(9, "Smite", true,false, 1, 1,0,2, 1,1, 4,3,-4, 0,1, false, nostate, confclarity);
        ability[9]=new Ability(10, "Hit", true,false, 1, 3,0,1, 0,1, 12,0,-4, 0,1, false, nostate, confsleep);
        ability[10]=new Ability(11, "Bash", true,false, 3, 3,0,5, 1,1, 7,5,-5, 0,1, false, dizziness, confclarity);
        ability[11]=new Ability(12, "Smash", true,false, 3, 5,0,3, 0,1, 18,0,-7, 0,1, false, nostate, confsleep);
        ability[12]=new Ability(13, "Berserk", true,false, 4, 7,0,4, 3,1, 0,0,0, -1,0, false, berserk, weakness);
        ability[13]=new Ability(14, "Shock", true,false, 4, 4,0,7, 1,1, 10,5,-9, 0,7, false, dizzystun, confclarity);
        ability[14]=new Ability(15, "Crush", true,false, 5, 7,4,0, 0,1, 25,0,-11, 0,1, false, stun, confsleep);
        ability[15]=new Ability(16, "Strike", true,true, 1, 0,0,0, 4,1, 13,0,-3, 0,1, 5,3, false, nostate, confsleep);
        ability[16]=new Ability(17, "Weaken", true,true, 1, 0,0,0, 4,1, 3,0,0, 0,1, 5,3, false, weakness, vigour);
        ability[17]=new Ability(18, "Dash", true,true, 3, 0,0,0, 4,1, 15,0,-5, 0,1, 3,7, false, nostate, confsleep);
        ability[18]=new Ability(19, "Poison", true,true, 3, 0,0,0, 4,2, 5,0,2, 0,1, 3,7, false, poison, regen);
        ability[19]=new Ability(20, "Pierce", true,true, 4, 0,0,0, 4,2, 15,0,-7, 0,1, 1,5, false, nostate, confsleep);
        ability[20]=new Ability(21, "Toxic Gas", true,true, 4, 0,10,0, 6,3, 1,1,1, 1,1, 3,7, false, tpoison, tregen);
        ability[21]=new Ability(22, "Cheer", true,true, 4, 0,10,0, 3,-1, 0,0,-5, -2,0, 5,7, false, vigour, cure);
        ability[22]=new Ability(23, "Venom Blade", true,false, 5, 0,0,0, 4,1, 17,0,-9, 0,1, 1,5, false, poison, conftregen);
        ability[23]=new Ability(24, "Absorb", true,true, 1, 0,0,3, 2,1, 0,7,-3, 0,6, true, nostate, nostate);
        ability[24]=new Ability(25, "Drain", true,true, 3, 0,10,0, 2,1, 15,0,-3, 0,6, true, nostate, nostate);
        ability[25]=new Ability(26, "Fireball", true,true, 1, 0,3,0, 2,1, 11,0,-5, 0,2, false, nostate, sleep);
        ability[26]=new Ability(27, "Iceshard", true,true, 1, 0,3,0, 2,1, 11,0,-5, 0,3, false, nostate, sleep);
        ability[27]=new Ability(28, "Lighting", true,true, 1, 0,3,0, 2,1, 11,0,-5, 0,4, false, nostate, sleep);
        ability[28]=new Ability(29, "Rock", true,true, 1, 0,3,0, 2,1, 11,0,-5, 0,5, false, nostate, sleep);
        ability[29]=new Ability(30, "Darkness", true,true, 1, 0,3,0, 2,1, 11,0,-5, 0,6, false, nostate, sleep);
        ability[30]=new Ability(31, "Flame", true,true, 3, 0,5,0, 2,1, 15,0,-7, 1,2, false, nostate, sleep);
        ability[31]=new Ability(32, "Blizzard", true,true, 3, 0,5,0, 2,1, 15,0,-7, 1,3, false, nostate, sleep);
        ability[32]=new Ability(33, "Storm", true,true, 3, 0,5,0, 2,1, 15,0,-7, 1,4, false, nostate, sleep);
        ability[33]=new Ability(34, "Earthquake", true,true, 3, 0,5,0, 2,1, 15,0,-7, 1,5, false, nostate, sleep);
        ability[34]=new Ability(35, "Eclipse", true,true, 3, 0,5,0, 2,1, 13,0,-7, 1,6, false, nostate, sleep);
        ability[35]=new Ability(36, "Flare", true,true, 5, 0,12,0, 2,2, 25,0,-9, 0,1, false, nostate, sleep);
        ability[36]=new Ability(37, "Light Ray", true,true, 1, 0,3,0, 3,1, 11,0,-5, 0,7, false, nostate, sleep);
        ability[37]=new Ability(38, "Light Burst", true,true, 3, 0,5,0, 3,1, 15,0,-7, 1,7, false, nostate, sleep);
        ability[38]=new Ability(39, "Confusion", true,true, 5, 0,15,0, 2,1, 0,0,0, 0,6, false, confusion, clarity);
        ability[39]=new Ability(40, "Sleep", true,true, 4, 0,0,17, 4,1, 3,0,17, 0,1, false, sleep, clarity);
        ability[40]=new Ability(41, "Slash", true,true, 5, 0,10,0, 4,1, 15,0,0, 1,1, 3,7, false, nostate, confsleep);
        ability[41]=new Ability(42, "Fire Wpn", true,false, 2, 0,3,2, 5,1, 17,0,-7, 0,2, false, nostate, confsleep);
        ability[42]=new Ability(43, "Ice Wpn", true,false, 2, 0,3,2, 5,1, 17,0,-7, 0,3, false, nostate, confsleep);
        ability[43]=new Ability(44, "Electric Wpn", true,false, 2, 0,3,2, 5,1, 17,0,-7, 0,4, false, nostate, confsleep);
        ability[44]=new Ability(45, "Stone Wpn", true,false, 2, 0,3,2, 5,1, 17,0,-7, 0,5, false, nostate, confsleep);
        ability[45]=new Ability(46, "Dark Wpn", true,false, 2, 0,3,2, 5,1, 17,0,-7, 0,6, false, nostate, confsleep);
        ability[46]=new Ability(47, "Vampiric Wpn", true,false, 5, 0,10,0, 5,1, 21,0,-9, 0,6, 3,7, true, nostate, confsleep);
        ability[47]=new Ability(48, "Reflect", true,true, 5, 0,10,0, 3,1, 0,0,0, 0,0, false, reflect, nostate);
        ability[48]=new Ability(49, "Meteor", true,true, 5, 0,17,0, 2,1, 19,0,-11, 1,1, false, nostate, sleep);
        ability[49]=new Ability(50, "Syphon", true,true, 4, 0,15,0, 2,1, 13,0,-3, 1,6, true, nostate, nostate);
        ability[50]=new Ability(51, "Dragon Breath", true,false, 4, 0,13,7, 5,1, 15,0,-11, 1,1, false, nostate, confsleep);
        ability[51]=new Ability(52, "Light Wpn", true,false, 2, 0,3,2, 7,1, 17,0,-5, 0,7, false, nostate, confsleep);
        ability[52]=new Ability(53, "Heal", false,true, 1, 0,3,0, 2,1, -25,0,0, 0,7, false, revive, nostate);
        ability[53]=new Ability(54, "Meditate", true,true, 1, 0,0,2, 2,1, -3,-7,0, -1,7, false, nostate, dizziness);
        ability[54]=new Ability(55, "Cure", false,true, 3, 0,7,0, 2,1, -17,0,0, 0,7, false, revive, cure);
        ability[55]=new Ability(56, "Clarity", true,true, 3, 0,0,7, 2,1, 0,-3,0, 0,7, false, clarity, madness);
        ability[56]=new Ability(57, "Absorb", true,true, 1, 0,0,3, 3,1, 0,7,-3, 0,7, true, nostate, nostate);
