...
namespace tbrpgsca
{
    ...
    public:
        ...
        inline State& inflict(QString& ret, Actor& actor, int dur, bool const always);
    ...
    protected:
        ...
        State& inflict(QString& ret, Scene* const scene, Actor& actor, int dur, bool const always);
