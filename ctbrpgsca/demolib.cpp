...
QVector<QVector<Ability*>*>& DemoLib::getAbilities()
{
    ...
    if (abilities.size() == 0)
    {
        ...
        skillSet->append(new Ability(1, tr("Attack"), "", false, false, false, true, 0, 0,0,0, DMG_TYPE_ATK,0, 10,0,0, FLAG_TRG_ONE,0, -1,-1, false, false, nullptr, stateMasks[10]));
        ...
        skillSet->append(new Ability(3, tr("Heal"), "", false, true, false, false, 0, 0,3,0, DMG_TYPE_SPI,0, -13,0,0, 0,0, -1,-1, false, true, nullptr, nullptr));
        abilities.append(skillSet);
    }
    return abilities;
}
