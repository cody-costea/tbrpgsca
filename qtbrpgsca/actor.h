...
namespace tbrpgsca
{
    ...
    class Actor : public Costume
    {
        ...
        PROP_FIELD_SET_ALL(Actor, setReflectDmgType, sawpReflectDmgType, withReflectDmgType, int, public, reflectDmgType, _rfl_type)
        PROP_FIELD_SET_ALL(Actor, setCoverDmgType, sawpCoverDmgType, withCoverDmgType, int, public, coverDmgType, _cvr_type)
